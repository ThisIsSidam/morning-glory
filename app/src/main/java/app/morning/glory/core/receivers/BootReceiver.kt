...
class BootReceiver : BroadcastReceiver() {
    ...
    private fun rescheduleAlarms(context: Context) {
        ...
        if (sleepAlarmTime != null) {
            ...
            Log.d("BootReceiver", "Rescheduling sleep alarm after reboot: ${sleepAlarmTime.friendly(context)}")
        }
        ...
        if (napAlarmTime != null) {
            ...
            Log.d("BootReceiver", "Rescheduling nap alarm after reboot: ${napAlarmTime.friendly(context)}")
        }
